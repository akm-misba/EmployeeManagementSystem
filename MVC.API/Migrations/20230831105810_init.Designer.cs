...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MVC.API.Models.Attendance", b =>
                {
            ...
            modelBuilder.Entity("MVC.API.Models.AttendanceSummary", b =>
                {
            ...
            modelBuilder.Entity("MVC.API.Models.Company", b =>
                {
                    b.Property<int>("ComId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MVC.API.Models.Department", b =>
                {
            ...
            modelBuilder.Entity("MVC.API.Models.Designation", b =>
                {
            ...
            modelBuilder.Entity("MVC.API.Models.Employee", b =>
                {
                    b.Property<int>("EmpId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MVC.API.Models.Salary", b =>
                {
            ...
            modelBuilder.Entity("MVC.API.Models.Shift", b =>
                {
                    b.Property<int>("ShiftId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MVC.API.Models.Attendance", b =>
                {
                    b.HasOne("MVC.API.Models.Company", "Company")
                        .WithMany()
                        .HasForeignKey("ComId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MVC.API.Models.Employee", "Employee")
                        .WithMany()
                        .HasForeignKey("EmpId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MVC.API.Models.Employee", b =>
                {
                    ...
                    b.HasOne("MVC.API.Models.Department", "Department")
                        .WithMany()
                        .HasForeignKey("DeptId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MVC.API.Models.Designation", "Designation")
                        .WithMany()
                        .HasForeignKey("DesigId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MVC.API.Models.Shift", "Shift")
                        .WithMany()
